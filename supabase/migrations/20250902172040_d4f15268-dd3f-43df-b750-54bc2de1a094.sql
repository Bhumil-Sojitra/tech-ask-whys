...
CREATE POLICY "Authenticated users can insert question tags" ON public.question_tags FOR INSERT TO authenticated WITH CHECK (true);
...
CREATE POLICY "System can insert reputation history" ON public.reputation_history FOR INSERT WITH CHECK (true);
