-- Fix security issues by setting search_path for reputation functions
DROP FUNCTION IF EXISTS update_reputation_on_vote() CASCADE;
...
-- Recreate triggers for reputation updates
